...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("===============================================================")
    print("== Result for \"{}\"".format(model))
    print("--------------------------------------------")
    print("== Total Imgs: \t\t\t {}".format(r["n_images"]))
    print("== Dog/Not dog Imgs: \t\t {}/{}".format(r["n_dogs_img"], r["n_notdogs_img"]))
    print("== No./Pct. of Match: \t\t {} / {}%".format(r["n_match"], round(r["pct_match"] * 100, 2)))
